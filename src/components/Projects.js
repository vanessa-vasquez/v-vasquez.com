...
import Librarians from "../assets/Librarians.svg";
                            ...
                            <Card>
                                <Card.Body>
                                    ...
                                    <div className='overlay'>
                                        <Card.Title className='project-title'>{projects[key]["title"]}</Card.Title>
                                        <Card.Text className='description'>{projects[key]["desc"]}</Card.Text>
                                        <Card.Text className='tools'>{projects[key]["tools"]}</Card.Text>
                                        ...
                                        {projects[key]["open"] != null &&
                                            <a href={projects[key]["open"]}><Display className='display-icon' size={40} /></a>
                                        }
                                    </div>
                                </Card.Body>
                            </Card>
