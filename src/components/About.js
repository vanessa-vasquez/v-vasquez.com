      ...
      <Row>
        <Col sm={12} md={11}>
          <div id="about-section">
            <div>
              ...
              <div className="bio">
                i’m currently a senior at Columbia University with a passion for
                creative coding and all things UI/UX.
              </div>
        ...
        <Col sm={12} md={1}>
          <div className="contact">
            <a href="https://github.com/vanessa-vasquez">
              <Github className="github-icon" size={40} />
            </a>
            <br />
            <a href="mailto:vv2317@columbia.edu">
              <Envelope className="mail-icon" size={40} />
            </a>
          </div>
        </Col>
      </Row>
